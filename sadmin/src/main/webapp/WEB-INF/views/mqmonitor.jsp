        ...
        <div id="content" class="span10">
            ...
            <div>
                <ul class="breadcrumb" id="title-001">
                    ...
                    <li>
                        <a href="<%=basePath%>mqmonitor.do">消息队列数据监控</a>
                    </li>
                </ul>
                <div class="row-fluid sortable">
                    <div class="box span12">
                        ...
                        <div class="box-content" id="mqmonitor">
                            ...
                            <form method="GET" id="mqmonitorForm" name="mqmonitorForm" action="mqmonitor.do"
                                  enctype="multipart/form-data">
                                <table class="table table-striped">
                                    <thead>
                                    <tr class="span6">
                                        时间 :<input type="date" name="date" value="${date}" style="width:120px"/>
                                        ...
                                        &nbsp;&nbsp;
                                        topic :<select id="facility" name="facility" class="form-control" >&nbsp;&nbsp;
                                        <c:forEach items="${facilityList}" var="facility" varStatus="i">
                                            <option value=${facility}
                                                    <c:if test="${facility.equals(faci)}">
                                                            selected
                                            </c:if>
                                            > ${facility} </option>
                                        </c:forEach>
                                    ...
                                    <c:forEach items="${resultList}" var="result" varStatus="i">
                                        <tr>
                                            <td class="center" id="facitity${i.index}">${result.facitity}</td>
                                            <td class="center" id="param3${i.index}"><a href="<%=basePath %>${result.url}" class=""> ${result.param3}</a></td>
                                            <td class="center" id="param1${i.index}"><a href="<%=basePath %>${result.url}" class=""> ${result.param1}</a></td>
                                            <td class="center" id="param2${i.index}"><a href="<%=basePath %>${result.url}" class="">${result.param2}</a></td>
                                            <td class="center" id="param4${i.index}"><a href="<%=basePath %>${result.url}" class="">${result.param4}</a></td>
                                            <td class="center" id="time${i.index}">${result.time}</td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                                </table>

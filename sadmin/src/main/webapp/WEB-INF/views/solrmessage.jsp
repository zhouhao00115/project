        ...
        <div id="content" class="span10">
            ...
            <div>
                <ul class="breadcrumb" id="title-001">
                    ...
                    <li>
                        <a href="<%=basePath%>solrmessage.do">solr服务器消息</a>
                    </li>
                </ul>
            </div>
            <div class="row-fluid sortable">
                <div class="box span12">
                    ...
                    <form method="get" id="SolrProjectForm" name="SolrProjectForm" action="solrmessage.do"
                          enctype="multipart/form-data">
                        <div class="box-content" id="LineMessage">
                            <table>
                                <tr>
                                    <td><a class="btn btn-primary"
                                           href="<%=basePath%>solrmessage.do?project=allprojcet">back</a></td>
                            ...
                            <c:if test="${proje.equals('hotword')}">
                                <jsp:include page="hotwordsolr.jsp"></jsp:include>
                            </c:if>
                        </div>
                    </form>
                </div>
...
<script src="js/solrmonitor.js"></script>
</body>
</html>

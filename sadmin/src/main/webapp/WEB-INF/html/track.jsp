        ...
        <div id="content" class="span10">
            ...
            <div class="row-fluid sortable">
                <div class="box span12">
                    ...
                    <div class="box-content" id="tracklist">
                        <c:if test="${'1' eq view}">
                            <jsp:include page="track/tracklist.jsp"></jsp:include>
                        </c:if>
                        <c:if test="${'2' eq view}">
                            <jsp:include page="track/trackinfo.jsp"></jsp:include>
                        </c:if>
                        <c:if test="${'3' eq view}">
                            <jsp:include page="track/trackadd.jsp"></jsp:include>
                        </c:if>
                    </div>
                </div>
            </div>

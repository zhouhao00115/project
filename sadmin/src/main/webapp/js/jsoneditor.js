...
/******/
/******/ 		// Check if models is in cache
/******/ 		if(installedModules[moduleId])
/******/ 			return installedModules[moduleId].exports;
/******/
/******/ 		// Create a new models (and put it into the cache)
...
/******/ 		};
/******/
/******/ 		// Execute the models function
/******/ 		modules[moduleId].call(module.exports, module, module.exports, __webpack_require__);
/******/
/******/ 		// Flag the models as loaded
/******/ 		module.loaded = true;
/******/
/******/ 		// Return the exports of the models
...
/******/
/******/ 	// expose the models cache
/******/ 	__webpack_require__.c = installedModules;
/******/
/******/ 	// __webpack_public_path__
/******/ 	__webpack_require__.p = "";
/******/
/******/ 	// Load entry models and return exports
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(1), __webpack_require__(2), __webpack_require__(3)], __WEBPACK_AMD_DEFINE_RESULT__ = function (treemode, textmode, util) {
	  ...
	  function JSONEditor (container, options, json) {
	    ...
	    // checker for unsupported browser (IE8 and older)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(9), __webpack_require__(10), __webpack_require__(3)], __WEBPACK_AMD_DEFINE_RESULT__ = function (ContextMenu, appendNodeFactory, util) {
	  ...
	  Node.prototype.setValue = function(value, type) {
	    ...
	    // checker if type corresponds with the provided type
	    ...
	    if (this.type == 'array') {
	      ...
	      /* TODO
	       ...
	       util.log('checker', value, this.value);
	       }
	       else {
	       this.value = value;
	       }
	...
	// stores the element name currently having the focus
	  ...
	  /**
	   * Check if given node is a child. The method will checker recursively to find
	   * this node.
	   * @param {Node} node
	  ...
	  Node.prototype._move = function(node, beforeNode) {
	    ...
	    // checker if this node is not a child of the node to be moved here
	  ...
	  Node.prototype._onDrag = function (event) {
	    ...
	    if (mouseY < topThis) {
	      ...
	      if (nodePrev) {
	        // checker if mouseY is really inside the found node
	  ...
	  Node.prototype.onEvent = function (event) {
	    ...
	    // checker if mouse is on menu or on dragarea.

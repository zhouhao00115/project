...
public interface OrderMapper {
    ...
    @Insert("insert into orders (oid,cid,tid,staffid,volume,price,total,createtime,remarks) values (#{oid},#{customerModel.cid},#{trackModel.tid},#{dataUserModel.staffid},#{volume},#{price},#{total},datetime('now'),#{remarks})")
